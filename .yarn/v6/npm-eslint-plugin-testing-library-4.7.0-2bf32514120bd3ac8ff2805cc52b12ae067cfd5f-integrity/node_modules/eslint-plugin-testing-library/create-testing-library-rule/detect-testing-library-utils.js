    ...
    return (context, optionsWithDefault) => {
        ...
        const isFireEventMethod = (node) => {
            ...
            const parentMemberExpression = node.parent && node_utils_1.isMemberExpression(node.parent)
                ? node.parent
                : undefined;
            const parentCallExpression = node.parent && node_utils_1.isCallExpression(node.parent) ? node.parent : undefined;
            ...
            const regularCall = experimental_utils_1.ASTUtils.isIdentifier(definedParentMemberExpression.object) &&
                node_utils_1.isCallExpression(definedParentMemberExpression.parent) &&
                definedParentMemberExpression.object.name === fireEventUtilName &&
                node.name !== FIRE_EVENT_NAME &&
                node.name !== fireEventUtilName;
            const wildcardCall = node_utils_1.isMemberExpression(definedParentMemberExpression.object) &&
            ...
            const wildcardCallWithCallExpression = experimental_utils_1.ASTUtils.isIdentifier(definedParentMemberExpression.object) &&
                ...
                !node_utils_1.isMemberExpression(definedParentMemberExpression.parent) &&
                node.name === FIRE_EVENT_NAME &&
                node.name !== fireEventUtilName;
        ...
        const isCreateEventUtil = (node) => {
            ...
            if (node_utils_1.isCallExpression(node) &&
                node_utils_1.isMemberExpression(node.callee) &&
            ...
            const identifier = node_utils_1.getDeepestIdentifierNode(node);
        ...
        const isDebugUtil = (identifierNode, validNames = utils_1.DEBUG_UTILS) => {
            const isBuiltInConsole = node_utils_1.isMemberExpression(identifierNode.parent) &&
        ...
        const isActUtil = (node) => {
            ...
            const isReactDomTestUtilsAct = (() => {
                ...
                const importedUtilSpecifier = node_utils_1.findImportSpecifier(node.name, importedReactDomTestUtilsNode);
                if (!importedUtilSpecifier) {
                    return false;
                }
                const importDeclaration = (() => {
                    if (node_utils_1.isImportDeclaration(importedUtilSpecifier.parent)) {
                        return importedUtilSpecifier.parent;
                    }
                    const variableDeclarator = node_utils_1.findClosestVariableDeclaratorNode(importedUtilSpecifier);
                    if (node_utils_1.isCallExpression(variableDeclarator === null || variableDeclarator === void 0 ? void 0 : variableDeclarator.init)) {
                ...
                const importDeclarationName = node_utils_1.getImportModuleName(importDeclaration);
                ...
                return node_utils_1.hasImportMatch(importedUtilSpecifier, referenceNodeIdentifier.name);
            })();
        ...
        const findImportedTestingLibraryUtilSpecifier = (specifierName) => {
            ...
            return node_utils_1.findImportSpecifier(specifierName, node);
        };
        ...
        const isNodeComingFromTestingLibrary = (node) => {
            ...
            const importDeclaration = (() => {
                if (node_utils_1.isImportDeclaration(importNode.parent)) {
                    return importNode.parent;
                }
                const variableDeclarator = node_utils_1.findClosestVariableDeclaratorNode(importNode);
                if (node_utils_1.isCallExpression(variableDeclarator === null || variableDeclarator === void 0 ? void 0 : variableDeclarator.init)) {
                    return variableDeclarator === null || variableDeclarator === void 0 ? void 0 : variableDeclarator.init;
                }
                return undefined;
            ...
            const hasImportElementMatch = node_utils_1.hasImportMatch(importNode, identifierName);
