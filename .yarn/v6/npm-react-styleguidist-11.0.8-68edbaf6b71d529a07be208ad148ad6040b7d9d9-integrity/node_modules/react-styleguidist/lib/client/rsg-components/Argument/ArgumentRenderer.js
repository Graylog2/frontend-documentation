...
export var ArgumentRenderer = function ArgumentRenderer(_ref2) {
  ...
  var content = /*#__PURE__*/React.createElement(Group, null, returns && 'Returns', name && /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(Name, null, name), type && ':'), type && /*#__PURE__*/React.createElement(Type, null, type.name, isOptional && '?', !!defaultValue && "=" + defaultValue), type && description && "\u2014", description && /*#__PURE__*/React.createElement(Markdown, {
    text: "" + description,
    inline: true
  }));
